...
const DEFAULT_SETTINGS: GlobalSettings = {
  ...
  gamesConfig: {
    ...
    blackjack: { enabled: true, order: 2, name: 'Блэкджек', description: 'Обыграй дилера', minBet: 25, maxBet: 5000 },
    crash: { enabled: true, order: 3, name: 'Crash', description: 'Успей забрать', minBet: 10, maxBet: 10000 },
    poker: { enabled: true, order: 4, name: 'Video Poker', description: 'Валеты или старше', minBet: 10, maxBet: 5000 },
  },
  bankDepositBonus: 10,
